...
_SYSTEM_DIRECTIVE = (
    ...
    "no visitor messages, no one has spoken to you yet. In either sub-case, strongly "
    "prefer [THINK_MORE] unless you have something genuinely worth sharing unprompted.\n\n"
    "Output format:\n"
